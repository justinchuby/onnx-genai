...
pub use pipeline::{
    AdapterActivation, AdapterLifecycleDiagnostic, AdapterSelection, PipelineGenerateRequest,
    PipelineTensors, RowScopedState, RowTable, WorkflowSessionCheckpoint,

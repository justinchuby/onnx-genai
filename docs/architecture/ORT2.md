...
> [`MEMORY_ARCHITECTURE.md`](../memory/MEMORY_ARCHITECTURE.md) for the measurement
> narrative.
...
> figure; see [`MEMORY_ARCHITECTURE.md`](../memory/MEMORY_ARCHITECTURE.md)). The timeline
...
> [`MEMORY_ARCHITECTURE.md`](../memory/MEMORY_ARCHITECTURE.md).

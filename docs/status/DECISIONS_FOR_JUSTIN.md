...
- **Pointer:** [`CUDA_CSA_PHASE_B_PLAN.md` D1](../execution/CUDA_CSA_PHASE_B_PLAN.md#L30-L44)
...
- **Pointer:** [`CUDA_CSA_PHASE_B_PLAN.md` D2](../execution/CUDA_CSA_PHASE_B_PLAN.md#L46-L59)
...
- **Recommended default:** fixed capacity from package metadata. Claim time
  ...
  satisfied.
- **Pointer:** [`CUDA_CSA_PHASE_B_PLAN.md` D3](../execution/CUDA_CSA_PHASE_B_PLAN.md#L61-L73)
...
- **Pointer:** [`CUDA_CSA_PHASE_B_PLAN.md` D4](../execution/CUDA_CSA_PHASE_B_PLAN.md#L75-L81)
...
- **Pointer:** [`CUDA_CSA_PHASE_B_PLAN.md` D5](../execution/CUDA_CSA_PHASE_B_PLAN.md#L83-L91)
...
- **Pointer:** [`CUDA_CSA_PHASE_B_PLAN.md` D6](../execution/CUDA_CSA_PHASE_B_PLAN.md#L93-L104)
...
- **Pointer:** [`CUDA_CSA_PHASE_B_PLAN.md` D7](../execution/CUDA_CSA_PHASE_B_PLAN.md#L106-L112)
...
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 1](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L385-L388)
...
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 2](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L390-L395)
...
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 3](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L397-L401)
...
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 4](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L403-L405)
...
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 5](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L407-L413)
...
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 6](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L415-L418)
...
- **Recommended default:** resident-first correctness for the GLM/IQ profile;
  ...
  support.
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 7](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L420-L431)
...
- **Pointer:** [`BLOCKQUANTIZEDMOE_DESIGN.md` decision 8](../quantization/BLOCKQUANTIZEDMOE_DESIGN.md#L433-L438)
...
- **Pointer:** [`KIMI_K_READINESS.md` decision 1](../models/KIMI_K_READINESS.md#L183-L186)
...
- **Pointer:** [`KIMI_K_READINESS.md` decision 2](../models/KIMI_K_READINESS.md#L187-L191)
...
- **Pointer:** [`KIMI_K_READINESS.md` decision 3](../models/KIMI_K_READINESS.md#L192-L196)
...
- **Pointer:** [`KIMI_K_READINESS.md` decision 4](../models/KIMI_K_READINESS.md#L197-L199),
...
- **Pointer:** [`KIMI_K_READINESS.md` decision 5](../models/KIMI_K_READINESS.md#L200-L201)
...
- **Pointer:** [`GRAPHVIEW_LENS_DESIGN.md`](../architecture/GRAPHVIEW_LENS_DESIGN.md#L9-L12)
...
- **Pointer:** [`GRAPHVIEW_LENS_DESIGN.md`](../architecture/GRAPHVIEW_LENS_DESIGN.md#L13-L13)
...
- **Pointer:** [`GRAPHVIEW_LENS_DESIGN.md`](../architecture/GRAPHVIEW_LENS_DESIGN.md#L14-L14)
...
- **Pointer:** [`GRAPHVIEW_LENS_DESIGN.md`](../architecture/GRAPHVIEW_LENS_DESIGN.md#L15-L15)
...
- **Pointer:** [team block](../../.squad/decisions.md#L741-L747),
  [frozen-contract export requirement](../models/DEEPSEEK_CSA_MTP_RUNTIME.md#L1620-L1624)

...
(`docs/status/PROGRESS.md:39-44`).  Fused GLM/DeepSeek expert exports can instead
emit `QMoE` (`docs/status/PROGRESS.md:32-35`), so SQNBitGemm is primarily the dense
...
`docs/status/PROGRESS.md:41-43` should not be represented as proof of half dense
MatMul use.

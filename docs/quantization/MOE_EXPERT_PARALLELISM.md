...
> Companion to [SCHEDULING.md](../genai/SCHEDULING.md) and [DESIGN.md](../architecture/DESIGN.md) §14.3 (Multi-GPU).
...
> by the `Communicator` trait. See [MEMORY_ARCHITECTURE.md §6](../memory/MEMORY_ARCHITECTURE.md).

...
decoding, sessions, batching) is covered in [DESIGN.md](../architecture/DESIGN.md); the Python binding
mechanics are covered in [ORT2.md](../architecture/ORT2.md) §24 and [EAGER.md](../execution/EAGER.md) §11.
...
`docs/execution/EAGER.md` §11–§12 and `docs/architecture/ORT2.md` §24 describe the PyO3/maturin binding layer living
...
**`nxrt` is already decided** (`docs/execution/EAGER.md` §11–12, `docs/architecture/ORT2.md` §24). To keep the runtime
...
already set for the binding layer (`docs/execution/EAGER.md` §11–12, `docs/architecture/ORT2.md` §24). Concretely:

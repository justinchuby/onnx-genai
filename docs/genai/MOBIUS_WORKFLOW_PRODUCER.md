...
This document records the Mobius producer contract and its measured
cross-repository evidence. The runtime-wide source of truth is
[`INFERENCE_METADATA_DECISIONS.md`](INFERENCE_METADATA_DECISIONS.md), and the
general producer surface is
...
Mobius
[`tests/canonical_workflow_contract_test.py`](https://github.com/onnxruntime/mobius/blob/main/tests/canonical_workflow_contract_test.py)
holds this invariant: it asks the

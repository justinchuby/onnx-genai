...
8. **Minimal-build composition.** A package must be analyzable into the
   ...
   [MINIMAL_BUILD.md](../architecture/MINIMAL_BUILD.md), including every runnable fallback
   variant.
...
One design/code mismatch must be explicit: `docs/architecture/ONNX_RS.md` specifies
...
specified in [MINIMAL_BUILD.md](../architecture/MINIMAL_BUILD.md). For EPContext nodes:
...
- Repository-local context:
  [ONNX_RS.md](../architecture/ONNX_RS.md), [ORT2.md](../architecture/ORT2.md),
  [DESIGN.md](../architecture/DESIGN.md), and [MINIMAL_BUILD.md](../architecture/MINIMAL_BUILD.md).

...
> Companion to [MOE_EXPERT_PARALLELISM.md](../quantization/MOE_EXPERT_PARALLELISM.md),
> [HETEROGENEOUS_PLACEMENT.md](../execution/HETEROGENEOUS_PLACEMENT.md),
> [SCHEDULING.md](../genai/SCHEDULING.md), and [DESIGN.md](../architecture/DESIGN.md).
>
...
[GRAPHVIEW_LENS_DESIGN.md](../architecture/GRAPHVIEW_LENS_DESIGN.md), but does not bolt on a
...
The `DispatchTransport` trait from [MOE_EXPERT_PARALLELISM.md §8](../quantization/MOE_EXPERT_PARALLELISM.md#8-communication-primitives)
...
> **Consolidated.** See [MEMORY_ARCHITECTURE.md §4-5](../memory/MEMORY_ARCHITECTURE.md).
...
- [WEIGHT_OFFLOAD.md](../memory/WEIGHT_OFFLOAD.md) — Three-tier weight residency, `ExpertStore`, `ResourceGovernor`
- [MOE_EXPERT_PARALLELISM.md](../quantization/MOE_EXPERT_PARALLELISM.md) — Session-per-GPU MoE architecture, `DispatchTransport` trait
- [HETEROGENEOUS_PLACEMENT.md](../execution/HETEROGENEOUS_PLACEMENT.md) — CPU+CUDA fallback placement (ON HOLD)
- [SCHEDULING.md](../genai/SCHEDULING.md) — Adaptive scheduling, EP negotiation protocol (§8)
- [DESIGN.md](../architecture/DESIGN.md) — Project architecture, KV cache manager (§3.2), paged memory

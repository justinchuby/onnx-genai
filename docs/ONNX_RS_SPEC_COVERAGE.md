...
| `TensorShapeProto` | `dim`(1) | ✅ | ⚠️ rank is represented; the shape registry covers 187 operators / 226 versioned entries, while the incomplete container/control-flow catalog limits full shape coverage | ✅ tensor/sparse signatures | ✅ | ✅ |

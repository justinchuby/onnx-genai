...
| Einsum | 12 | Native CPU execution for canonical view/diagonal, reduction/elementwise, and binary GEMM/BMM plan classes (`f32`/`f16`/`bf16`); general N-way contractions decline with a structured reason. See [EINSUM_PLANNING.md](EINSUM_PLANNING.md). |

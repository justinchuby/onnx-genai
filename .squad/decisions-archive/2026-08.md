...
## ARCHIVED 2026-08-12T00:00:00Z (Scribe CUDA-graph-capture-arc wave)

Narrative waves moved out of live `decisions.md` to keep it lean during the CUDA-graph
capture arc consolidation: the initial nxrt EP PyPI publish narrative (superseded by the
consolidated EP-wheel entry now in live decisions.md), the #762 memory-safety wave, and the
merged upstream ORT PR waves (#31973 / #31974 / #32001 / #32003, BF16 PrePack coverage, EP
plugin parity lessons, NaN semantics, regression wave, stale status snapshot). All standing
directives were preserved in live `decisions.md`; only merged/superseded narrative moved here.

<!-- moved: nxrt EP plugins on PyPI + CUDA 13 target (initial publish narrative) -->
## nxrt EP plugins on PyPI + CUDA 13 target (2026-08-12) [ARCHIVED]
...
<!-- moved: #762 Opus memory-safety wave -->
## Current active wave — 2026-08-12 (#762 Opus memory-safety wave) [ARCHIVED]
...
<!-- source: .squad/decisions/inbox/leon-762-test-followups.md -->
...
<!-- moved: merged upstream ORT PR waves + BF16 PrePack + #762 parity + regression -->

...
- 2026-07-14T19:05:00Z — Offline per-EP ONNX conformance harness and `docs/execution/EP_CONFORMANCE.md` merged to origin/main in `1dfab0d`; process-bridge design recorded in decisions.

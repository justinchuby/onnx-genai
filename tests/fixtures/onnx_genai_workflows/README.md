...
The decoder, VLM, diffusion, masked diffusion, speculative, codec, video, and
adapter packages contain executable synthetic models. The adapter package
includes portable JSON and PEFT/safetensors artifacts. The TTS fixture uses the
real tiny Qwen3-TTS producer graphs with deterministic synthetic weights. No
